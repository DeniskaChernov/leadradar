...
from app.db.models import CostEvent, Deal, DealStatus, Lead
...
async def test_snapshot_uses_persisted_costs_and_outcomes(session_factory):
    ...
    assert report.commercial_signals_count == 1
    ...
    assert "USD" in report.roi_status and "UZS" in report.roi_status
