...
**V4.1 Foundation · Stage 3/7 · Signal First**
...
- Audience Engine, Significant Change Detector и Competitor Intelligence V2 остаются следующими
  этапами и ещё не помечены как готовые.
