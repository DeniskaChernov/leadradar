...
**V3.5 · Stage 3/7 · Deep lead intelligence**
...
- полный `pytest`: **57 passed**; тесты не обращаются к Instagram/OpenAI и не расходуют API-токены.
- `ruff check .`, compileall и data-integrity check: passed.
- все 12 проверенных web-маршрутов отвечают `200`; browser console ошибок не содержит, horizontal overflow
  основного layout равен `0`.
- Alembic head: `f31a8c74d920`; autogenerate check не нашёл новых операций.
