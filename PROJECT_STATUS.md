...
**V4.1 Foundation · Stage 3/7 · Audience Engine**
...
- миграция `a417d8e2c691` проверена на рабочей и пустой SQLite-базе;
...
- Audience Engine завершён; Significant Change Detector и Competitor Intelligence V2 остаются
  следующими этапами и ещё не помечены как готовые.
